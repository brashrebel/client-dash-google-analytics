...
class CDGoogleAnalytics {

	/*
	* These variables you can change
	*/
	// Define the plugin name
	private $plugin = 'Client Dash Google Analytics';
	// Setup your prefix
	private $pre = 'cdga';
	// Set this to be name of your content block
	private $block_name = 'Google Analytics';
	// Set the tab slug and name
	private $tab = 'analytics';
	...
	*/
	...
	<table class="form-table">
		<tbody>
			...
			<tr valign="top">
				<th scope="row">
					<label for="<?php echo $url_option; ?>">API URL</label>
				</th>
				<td><input type="text" 
...
$cdgoogleanalytics = new CDGoogleAnalytics;